    ...
    return (
        <section className="leaderboard">
            ...
            {leaderboardData
                ...
                .map((company, index) => (
                    <div className='company-bubble' key={company.id} 
                        ...
                        onClick={() => window.location.href = `leaderboard/${company.id}`}
                        >
                        <div className='company-bubble__name'>{company.name}</div>
                        <div className="company-bubble__stats-wrapper">
                            <div className='stats-item'><img src={`${peopleGroupIcon}`} alt="Employee Count" />{company.employeeCount}</div>
                            <div className='stats-item'><img src={`${starIcon}`} alt="Company Score" />{company.score}</div>
                            <div className='stats-item'><img src={`${medalIcon}`} alt="Medals won" />{company.medals}</div>
                        </div>
                    </div>
                ))}
            </div>
