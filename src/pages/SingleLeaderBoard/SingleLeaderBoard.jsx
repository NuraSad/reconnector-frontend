...
const leaderboard = [
  ...
  },
  {
    ...
    week_streaks: 12,
    groups_apart_of: 157,
    most_active_group: ["#Mountain Bike Ride", "#Girls Running and Drinks",'#Hiking park'],
  },
  {
    username: "Alex Ray",
    total_starts: 800,
    ...
    <div className="singleleaderboard">
      <div className="singleleaderboard-first">
        ...
        <section className="singleleaderboard-first-description">
          <h1 className="company-heading"> Starbucks</h1>
          ...
          <p className="company-description">
            ...
            lacinia eros vitae nunc feugiat sollicitudin. Donec suscipit, erat a
            rhoncus cursus, orci dui varius augue, vel blandit augue magna ut
            orci. Pellentesque in lorem volutpat, blandit urna eu, laoreet
            magna. Pellentesque sed eros tellus.
          </p>
        </section>
      </div>
